...
public class MyAdapter4 {
    ...
    public long insertData(String vsource,String vdes, String vfare)
    {
    ...
    public String getData()
    {
        ...
        String[] columns = {myDbHelper.CID, myDbHelper.SOURCE, myDbHelper.DESTINATION};
        ...
        while (cursor.moveToNext())
        {
            ...
            buffer.append(vvid +"   "+vvsource+"   "+vvdes+"   "+" \n");
        }
    ...
    {
        private static final String DATABASE_NAME = "VoterGmail4";    // Database Name
        private static final String TABLE_NAME = "Fare";   // Table Name
        ...
        private static final String FARE = "Cartype";
        private static final String CREATE_TABLE = "CREATE TABLE "+TABLE_NAME+
                " ("+CID+" INTEGER PRIMARY KEY AUTOINCREMENT, "+SOURCE+" VARCHAR(255),"+DESTINATION+" VARCHAR(255),"+FARE+" VARCHAR(255));";
