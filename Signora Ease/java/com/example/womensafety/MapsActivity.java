...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public static String pickup_place,ctype;
...
//    private GoogleMap mMap;
//    String so ,dest;
//    LatLng source,destination,currentl;
...
//            currentl=new LatLng(latitude,longitude);
//            //mMap.addMarker(new MarkerOptions().position(currentl).title("Destination"));
...
//        }
//
//        source = new LatLng(41.385064,2.173403);
//        destination = new LatLng(40.416775,-3.70379);
//
//        so= getIntent().getStringExtra("so");
//        dest=getIntent().getStringExtra("des");
//        mapFragment.getMapAsync(this);
//    }
//
//    @Override
...
//                            dlat = Double.toString(a.getLatitude());
//                            dlong = Double.toString(a.getLongitude());
//                        }
//                    }
//                } catch (IOException e) {
...
//                }
//            }
//            mMap.addMarker(new MarkerOptions().position(currentl).title("loc"));
//            mMap.moveCamera(CameraUpdateFactory.newLatLng(currentl));
//            float zoomlevel = 16.0f;
//            mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(currentl, zoomlevel));
//
//            mMap.addMarker(new MarkerOptions().position(destination).title("Destination"));
//
//            Polyline line = mMap.addPolyline(new PolylineOptions()
//                    .add(currentl, destination)
//                    .width(5)
//                    .color(Color.RED));
//        }
//        else {
...
//                    for (Address a : addresses) {
//                        if (a.hasLatitude() && a.hasLongitude()) {
//                            source = new LatLng(a.getLatitude(), a.getLongitude());
//                            ll.add(new LatLng(a.getLatitude(), a.getLongitude()));
//                            slat = Double.toString(a.getLatitude());
//                            slong = Double.toString(a.getLongitude());
//                        }
//                    }
//
//                    location = dest;
...
//            float zoomlevel = 16.0f;
//            mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(source, zoomlevel));
//
//            mMap.addMarker(new MarkerOptions().position(destination).title("Destination"));
//
//            Polyline line = mMap.addPolyline(new PolylineOptions()
...
//        {
//
//            Intent intent=new Intent(MapsActivity.this,Order.class);
